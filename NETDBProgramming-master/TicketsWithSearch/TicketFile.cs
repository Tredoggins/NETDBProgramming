...
namespace TicketsWithSearch
{
    abstract class TicketFile
    {
        ...
        public virtual List<Ticket> searchByStatus(string part)
        {
            return tickets.Where(t => t.status.Contains(part)).ToList();
        }
        public virtual List<Ticket> searchByPriority(string part)
        {
            return tickets.Where(t => t.priority.Contains(part)).ToList();
        }
        public virtual List<Ticket> searchBySubmitter(string part)
        {
            return tickets.Where(t => t.submitter.Contains(part)).ToList();
        }
    }
